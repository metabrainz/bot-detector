...
func TestDetermineIdentity_SingleNodeLeader(t *testing.T) {
	...
	identity, err := DetermineIdentity(tmpDir, []string{":8080"}, "", nil)
	if err != nil {
...
func TestDetermineIdentity_Follower(t *testing.T) {
	...
	identity, err := DetermineIdentity(tmpDir, []string{":9090"}, "", nil)
	if err != nil {
		t.Fatalf("Expected no error, got: %v", err)
	}
...
func TestDetermineIdentity_WithClusterConfig_ExactMatch(t *testing.T) {
	...
	identity, err := DetermineIdentity(tmpDir, []string{"localhost:8080"}, "", clusterCfg)
	if err != nil {
		t.Fatalf("Expected no error, got: %v", err)
	}
...
func TestDetermineIdentity_WithClusterConfig_PortMatch(t *testing.T) {
	...
	identity, err := DetermineIdentity(tmpDir, []string{":8080"}, "", clusterCfg)
	if err != nil {
		t.Fatalf("Expected no error, got: %v", err)
	}
...
func TestDetermineIdentity_WithClusterConfig_0000PortMatch(t *testing.T) {
	...
	identity, err := DetermineIdentity(tmpDir, []string{"0.0.0.0:8080"}, "", clusterCfg)
	if err != nil {
		t.Fatalf("Expected no error, got: %v", err)
	}
...
func TestDetermineIdentity_WithClusterNodeName(t *testing.T) {
	...
	t.Run("it identifies correctly by name", func(t *testing.T) {
		...
		identity, err := DetermineIdentity(tmpDir, []string{":8080"}, "node-2", clusterCfg)
		if err != nil {
			t.Fatalf("Expected no error, got: %v", err)
		}
	...
	t.Run("it returns an error for an unknown name", func(t *testing.T) {
		_, err := DetermineIdentity(tmpDir, []string{":8080"}, "unknown-node", clusterCfg)
		if err == nil {
...
func TestDetermineIdentity_WithClusterConfig_NoMatch(t *testing.T) {
	...
	identity, err := DetermineIdentity(tmpDir, []string{":7070"}, "", clusterCfg)
	if err != nil {
		t.Fatalf("Expected no error, got: %v", err)
	}
...
func TestDetermineIdentity_FollowerWithNodeName(t *testing.T) {
	...
	identity, err := DetermineIdentity(tmpDir, []string{":9090"}, "", clusterCfg)
	if err != nil {
		t.Fatalf("Expected no error, got: %v", err)
	}
...
func TestDetermineIdentity_FollowerWithUnknownNodeName(t *testing.T) {
	...
	_, err := DetermineIdentity(tmpDir, []string{":9090"}, "", clusterCfg)
	if err == nil {
...
func TestDetermineIdentity_FollowerWithNodeNameButNoClusterConfig(t *testing.T) {
	...
	_, err := DetermineIdentity(tmpDir, []string{":9090"}, "", nil)
	if err == nil {
